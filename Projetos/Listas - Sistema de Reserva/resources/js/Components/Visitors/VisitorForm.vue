...
<template>
  <form @submit.prevent="submit" class="space-y-6 p-6 bg-white shadow-2xl rounded-lg max-w-md mx-auto">
    <h2 class="text-xl font-bold mb-4">Cadastrar Visitante</h2>
    <!-- Nome -->
    <div>
      <label for="name" class="block text-sm font-medium text-gray-700">Nome</label>
      <input id="name" v-model="form.name" type="text" placeholder="Digite o seu nome"
    ...
    <div>
      ...
      <input id="cpf" v-model="form.cpf" type="text" placeholder="Digite o seu CPF"
        class="mt-2 w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        required />
    </div>
    ...
    <!-- Tipo de Ingresso -->
    <div>
      <label for="ticket_type" class="block text-sm font-medium text-gray-700">Tipo de Ingresso</label>
      <select id="ticket_type" v-model="form.ticket_type"
        ...
        <option value="annual_pass">Passe Anual</option>
      </select>
    </div>

    <!-- Cartão de Crédito -->
    <div>
      <label for="credit_card" class="block text-sm font-medium text-gray-700">Número do Cartão de Crédito</label>
      <input id="credit_card" v-model="form.credit_card" type="text"
