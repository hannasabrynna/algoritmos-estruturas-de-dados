...
<body class="p-4">
    ...
    <div class="container">
        ...
        {{-- Ver posição na fila --}}
        <div class="card mb-4">
            <div class="card-header">4. Ver minha posição na fila</div>
            <div class="card-body">
                <form method="GET" action="{{ route('queue.position') }}">
                    <div class="mb-3">
                        <label for="visitor_id" class="form-label">ID do Visitante</label>
                        <input type="number" name="visitor_id" id="visitor_id" class="form-control" required>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary">Ver posição</button>
                </form>

                @if(isset($positionMessage))
